...
from contact.views.pride_event_views import PrideDateEventsView, PrideEventsView
...
urlpatterns = [
    ...
    path(
        BASE_PATH_SERVICE + "/pride/date-events",
        PrideDateEventsView.as_view(),
        name="contact-pride-date-events",
    ),
]
