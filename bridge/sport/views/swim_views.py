...
class SwimScheduleView(generics.GenericAPIView):
    ...
    def get(self, request, swim_location_name: str) -> Response:
        ...
        for day_offset in range(calendar_days):
            ...
            schedule = zwembaden_api_service.get_schedule_for_date_and_location(date_str=day_str, location_name=swim_location_name)
...
class SwimActivitiesView(generics.GenericAPIView):
    ...
    def get(self, request, swim_location_name: str) -> Response:
        ...
        response_dict = zwembaden_api_service.get_activities_for_location(location_name=swim_location_name)
